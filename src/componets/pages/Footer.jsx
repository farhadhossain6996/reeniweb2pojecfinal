...
<div className="">
 ...
 <h2 className='text-[50px] text-black dark:text-white   font-bold font-rajdhani leading-15 lg:w-[50%] w-full mt-5.5'>Get Ready <span className='font-normal'>To Create Great</span></h2>
